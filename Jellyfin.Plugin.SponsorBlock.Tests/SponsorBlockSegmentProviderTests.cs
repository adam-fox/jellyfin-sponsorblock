...
{
	[Fact]
	public void MapSegments_ConvertsApiResponseToDto()
	{
		...
		var result = SponsorBlockSegmentProvider.MapSegments(apiSegments, itemId);
	...
	[Fact]
	public void MapSegments_SkipsUnknownCategories()
	{
		var apiSegments = new List<SponsorBlockSegment>
		{
			new()
		...
		var result = SponsorBlockSegmentProvider.MapSegments(apiSegments, Guid.NewGuid());
		Assert.Empty(result);
	}

	[Fact]
	public void MapSegments_SkipsNonSkipActionTypes()
	{
		var apiSegments = new List<SponsorBlockSegment>
		{
			new()
